	...
	<center style="width: 100%; background-color: #f1f1f1;">
		...
		<div style="max-width: 600px; margin: 0 auto;" class="email-container">
				...
				<tbody>
					<tr>
						<td class="bg_white logo" style="padding: 1em 2.5em; text-align: center">
							<img src="http://legisjuristas.com/public/assets/img/legis-mail.png" alt="Legis Juristas" width="200">
						</td>
					</tr>
					<tr>
						<td class="hero" style="background-image: url('http://legisjuristas.com/public/assets/img/slider.jpg'); background-size: cover; height: 400px;" valign="middle">
							<table>
								<tbody>
									<tr>
										<td>
			...
			<table role="presentation" style="margin: auto;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
				...
				<h3 class="heading">Legis Juristas</h3>
				<p style="color:#fdfdfd">Somos una empresa dedicada a la capacitación y difusión de temas relacionados a las ciencias jurídicas.</p>
				</td>
				</tr>
				</tbody></table>
				</td>
				...
				<tbody><tr>
				<td style="text-align: left; padding-right: 10px;">
				<p style="color:#fdfdfd">© 2020 Legis Juristas - Derechos Reservados</p>
				</td>
				</tr>
				</tbody></table>
				</td>
